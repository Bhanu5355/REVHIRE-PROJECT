    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println("âš ï¸� " + ve.getMessage());
            } catch (InvalidCredentialsException ice) {
                System.out.println("âš ï¸� " + ice.getMessage());
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    private static void jobSeekerMenu(Scanner sc, int seekerId) {
        ...
        while (true) {
            ...
            // 2. VIEW RESUME
                ...
                if (r == null) {
                    System.out.println("âš ï¸� No resume found");
                } else {
                    System.out.println("\n--- My Resume ---");
         ...
         // ---------- WITHDRAW APPLICATION ----------
                ...
                if (ok) {
                    System.out.println("âœ… Application withdrawn successfully");
                } else {
                    System.out.println("â�Œ Unable to withdraw application");
                }
            }
    ...
    private static void employerMenu(Scanner sc) {
        ...
        while (true) {
            ...
            if (option == 1) {
                ...
                System.out.println("â�Œ Applicant rejected");
            }
